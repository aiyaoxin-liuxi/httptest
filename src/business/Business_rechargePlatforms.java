...
/**
 * rechargePlatforms类，开发使用，可以删除
 * @author 刘熙
 *
 */
public class Business_rechargePlatforms {
...
//		map.put("conEmail", "");
	...
	public Map<String, Object> confirmOrder(){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("merchantNo", "000001");
		map.put("zOrderNo", "17012010344602341525");
		map.put("outOrderNo", "222222");
		map.put("orderNo", "T17012001001");
		map.put("payAmount", "1537");
		return addSign(map);
	}
	...
	public Map<String, Object> bounce(){
		...
		map.put("outOrderNo", "222222");
		map.put("orderNo", "T17012001001");
		map.put("ticketNos", "201949,201948");
		return addSign(map);
	}
...
//		map.put("data", xml);
		...
		testMap3.put("SeatName", "101");
		testMap3.put("TicketPrice", "192");
		testMap3.put("RefundAmount", "0");
		...
		testMap1.put("OrderNo", "T17011901003");
