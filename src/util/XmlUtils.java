...
//		sb.append("</root>");
	 ...
	 * @return
	 */
	public static String getMapToXmlNotify(Map<String, Object> map) {
		// System.out.println("将Map转成Xml, Map：" + map.toString());
		StringBuffer sb = new StringBuffer();
		sb.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
		sb.append("<ReceiveTicketStatusRet xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">");
//		sb.append("<root>");
		mapToXML(map, sb);
		sb.append("</ReceiveTicketStatusRet>");
		// System.out.println("将Map转成Xml, Xml：" + sb.toString());
//		sb.append("</root>");
		try {
			return sb.toString();
