...
//	}
	...
	public static String executeNotice(Map<String,Object> parameters){
		...
		if(url.startsWith("https://")){	//调用Https
			ret = HttpClientUtil.httpsPost(url,ordersn,uuid, (Map<String,Object>)(parameters.get(Constants.PARAMETER_NAME_PARAMETERS)));
		}else if(url.startsWith("http://")){	//调用http
			ret = HttpClientUtil.httpPost(url,ordersn,uuid, (Map<String,Object>)(parameters.get(Constants.PARAMETER_NAME_PARAMETERS)));
